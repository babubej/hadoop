...
public class CoreRpEligibilityTest {
    ...
    public void setUp() throws IOException {
       params = new String [] {
            ...
            "OUTPUT_PATH=build/output/eligibility_rp/"
        };
        pigScript = "./src/main/pig/rp_eligibility.pig";
        aliasToCompare = "rp_eligibility";
        expectedFile = "src/test/resources/pigunit/output/core/eligibility_rp/rp_eligibility.expected";  
    }
    
    @Test
    public void testCoreRpEligibility() throws IOException, ParseException {
    ...
    public static String [] scriptCombinePartFile(String expectedOutputLocation) {
        ...
        String [] mergeFiles = {
            "fs -getmerge build/output/eligibility_rp/part* " + actualOutputLocation
