...
public class CoreRplFactTest {
    private static PigServer pigServer ;
    private static PigContext pigContext ;
    private static Cluster cluster ;
    private static PigTest test ;
    private static final Log LOG = LogFactory.getLog(CoreRplFactTest.class);
    ...
    public void setUp() throws IOException {
       params = new String [] {
            "JOB_NAME=EXTRACT-RPL",
            "QUEUE_NAME=etl",
            "MAX_SPLIT_SIZE=268435456",
            "DATE_STAMP=2015-07-20",
            "INPUT_RPL_PATH=src/test/resources/pigunit/input/extract/rpl/dt=2015-07-20/*",
            "INPUT_AIR_PATH=src/test/resources/pigunit/input/sqoop/air/dt=2015-07-20/*",
            "INPUT_DSD_PATH=src/test/resources/pigunit/input/sqoop/dsd/dt=2015-07-20/*",
            "INPUT_LOC_DETAIL_PATH=src/test/resources/pigunit/input/extract/location_detail/dt=2015-07-20/*",
            "INPUT_LOC_BXZ_PATH=src/test/resources/pigunit/input/extract/location_boxsize/dt=2015-07-20/*",
            "INPUT_SIOC_PATH=src/test/resources/pigunit/input/sqoop/sioc/*",
            "OUTPUT_PATH=build/output/rpl_fact/"
        };
        pigScript = "./src/main/pig/rpl_fact.pig";
        aliasToCompare = "project_rpl_fact";
        expectedFile = "src/test/resources/pigunit/output/core/rpl_fact/rpl.expected";  
    }

    @Test
    public void testRplFact() throws IOException, ParseException {
    ...
    public static String [] scriptCombinePartFile(String expectedOutputLocation) {
        ...
        String [] mergeFiles = {
            "fs -getmerge build/output/rpl_fact/part* " + actualOutputLocation
